...
The `make run` target of the Makefile builds and runs the sample application
...
The header file [fb.h](/header#fb) documents the operation of each function.  
...
[gl.h](/header#gl) for documentation of the basic drawing functions:
...
Lab 6 introduced you to the [font.h](/header#font)
