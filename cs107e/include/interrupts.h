 ...
 * process it. A handler takes two arguments. The first argument is of
 * type unsigned int (value of interrupted pc) and second argument is a
 * void * to reference auxiliary data. The handler returns a bool, which
 * indicates whether the interrupt was successfully processed.
 */
typedef bool (*handler_fn_t)(unsigned int, void *);
